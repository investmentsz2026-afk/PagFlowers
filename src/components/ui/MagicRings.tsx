...
export default function MagicRings({
  ...
  const activeColor = isDark ? (darkColor || color) : (lightColor || color);
  const activeColorTwo = isDark ? (darkColorTwo || colorTwo) : (lightColorTwo || colorTwo);

  propsRef.current = {
    color: activeColor, colorTwo: activeColorTwo, speed, ringCount, attenuation, lineThickness,
